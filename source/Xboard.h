...
class Xboard
{
  ...
  private:
    ...
    char *MoveToText(Move_t move);            // converts the move from your internal format to text like e2e2, e1g1, a7a8q.
    Move_t ParseMove(char *moveText);         // converts a long-algebraic text move to your internal move format
